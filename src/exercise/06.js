...
function PokemonInfo({pokemonName}) {
  ...
  React.useEffect(() => {
    ...
    /*
    // Essa abordagem não funciona poique o JS trabalha de forma assíncrona
    ...
    */
    ...
    // Uma Promisse, suporta dois callbacks, um para quando a execução assincrona da certa
    ...
    */
    ...
    async function getPokemonFromServer(){
        ...
        catch(erro) { // Em caso de erro, caímos do bloco Catch()
            setError(erro)
            setStatus('rejected')
        }
    }
